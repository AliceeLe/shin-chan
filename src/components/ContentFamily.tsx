...
const ContentFamily: React.FC = () => {
  return (
    <div className="h-full w-1/2 bg-light-cream flex flex-col gap-4 px-10 py-10 overflow-y-scroll">
      <h2 className="text-4xl text-teal-500 mb-4">
        How Family Dynamic is explored
      </h2>{" "}
